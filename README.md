...
Currently, to generate the audio preview an external tool, [FMGon](https://github.com/katahiromz/fmgon) is used, and a binary is included.  To compile the preview generator requires linking against OpenAL and alut. A future version may incorporate the preview engine as an AudioStreamGenerator as part of Godot's audio system, removing this requirement.
